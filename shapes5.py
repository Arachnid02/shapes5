...
#Sets the lower left side of the window to be 0,0 and upper right side to be 1000,1000
window.setCoords(0, 0, 1000, 1000)

#Creates a triangle, makes it red, and draws it in the lower left side of the window
triangle = Polygon(Point(50, 50), Point(50, 200), Point(200, 50))
triangle.setFill(color_rgb(255, 0, 0))
triangle.draw(window)

#Creates a square, makes it green, and draws it in the upper left side of the window
square = Polygon(Point(50, 950), Point(200,950), Point(200, 800), Point(50, 800))
square.setFill(color_rgb(0, 255, 0))
square.draw(window)

#Creates a pentagon, makes it blue, and draws it in the upper right side of the window
...
#Creates a heaxagon, makes it black, and draws it in the lower right side of the window
